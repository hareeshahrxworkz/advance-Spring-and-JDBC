		...
		<div class="card text-white bg-primary mb-3" style="width: 40rem;">
			<div class="card-body">
				...
				<form action="update" method="post">
					<a href="find?All" class="btn-close " aria-label="Close"></a>

					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Game
							Id </label> <input type="text" class="form-control"
							id="formGroupExampleInput" readonly="readonly" name="id"
							value="${dto.id}" />
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Game
							Name </label> <input type="text" class="form-control"
							id="formGroupExampleInput" readonly="readonly"
							placeholder="Enter  Game Name" name="name" value="${dto.name}" />
					</div>
					...
					<div>
						Online<select class="form-select form-select-lg mb-3"
							...
							<option value="${dto.online}">${dto.online}</option>
					...
					<div>
						No OF Levels<select class="form-select form-select-lg mb-3"
							...
							<option value="${dto.getNoOfLevels()}">${dto.getNoOfLevels()}</option>
					...
					<div>
						playars<select class="form-select form-select-lg mb-3"
							...
							<option value="${dto.playars}">${dto.playars}</option>
					...
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Game
							...
							name="Wepon" value="${dto.getWepon()}"/ >
					</div>
					<div class="d-grid gap-2 d-md-block">
						<input type="submit" value="Update" class="btn btn-warning" /> <a
							href="find?All" class="btn btn-warning" />Back
					</a>
			</div>
